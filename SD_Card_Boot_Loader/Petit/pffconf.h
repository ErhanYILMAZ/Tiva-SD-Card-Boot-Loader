...
#define DLY_US(n)	ROM_SysCtlDelay((ROM_SysCtlClockGet()/3000000)*n);	// Delay n microseconds 
#define	FORWARD(d)	forward(d)	/* Data in-time processing function (depends on the project) */

#define	CS_H()		ROM_GPIOPinWrite(SDC_GPIO_PORT_BASE, SDC_SSI_FSS, SDC_SSI_FSS)
#define CS_L()		ROM_GPIOPinWrite(SDC_GPIO_PORT_BASE, SDC_SSI_FSS, 0);
